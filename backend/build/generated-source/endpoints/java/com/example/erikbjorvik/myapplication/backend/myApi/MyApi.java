...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @return the request
   */
  public SayHi sayHi(java.lang.String overskrift, java.lang.String notatet, java.lang.String enhetsID) throws java.io.IOException {
    SayHi result = new SayHi(overskrift, notatet, enhetsID);
    initialize(result);
    return result;
  }
  ...
  public class SayHi extends MyApiRequest<com.example.erikbjorvik.myapplication.backend.myApi.model.MyBean> {
    ...
    private static final String REST_PATH = "{overskrift}/{notatet}/{enhetsID}";
     ...
     * @since 1.13
     */
    protected SayHi(java.lang.String overskrift, java.lang.String notatet, java.lang.String enhetsID) {
    ...
    public SayHi setOverskrift(java.lang.String overskrift) {
    ...
    public SayHi setNotatet(java.lang.String notatet) {
    ...
    public SayHi setEnhetsID(java.lang.String enhetsID) {
