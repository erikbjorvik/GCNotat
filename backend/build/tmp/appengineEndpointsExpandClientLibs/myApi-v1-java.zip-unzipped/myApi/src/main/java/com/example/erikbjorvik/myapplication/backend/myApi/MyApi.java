...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @return the request
   */
  public SayHi sayHi(java.lang.String overskrift, java.lang.String notatet) throws java.io.IOException {
    SayHi result = new SayHi(overskrift, notatet);
    initialize(result);
    return result;
  }
  ...
  public class SayHi extends MyApiRequest<com.example.erikbjorvik.myapplication.backend.myApi.model.MyBean> {
    ...
    private static final String REST_PATH = "{overskrift}/{notatet}";
     ...
     * @since 1.13
     */
    protected SayHi(java.lang.String overskrift, java.lang.String notatet) {
